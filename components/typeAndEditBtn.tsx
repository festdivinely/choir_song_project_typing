  ...
  return (
    <section className="flex justify-center items-center gap-x-4 sm:gap-x-10 md:gap-x-16 my-4">
      <div
        ...
        className="bg-[linear-gradient(to_bottom_right,_#1E6091_10%,_#184E77_90%)] shadow-md cursor-pointer flex flex-col border border-white/30 rounded-lg p-10 gap-1 text-center max-w-[140px] sm:max-w-xs transition-transform hover:scale-105 text-white"
      >
        <h1 className="text-base font-semibold">TYPE 
        </h1>
      ...
      <div
        ...
        className="bg-[linear-gradient(to_bottom_right,_#1E6091_10%,_#184E77_90%)] shadow-md cursor-pointer flex flex-col border border-white/30 rounded-lg p-10 gap-1 text-center max-w-[140px] sm:max-w-xs transition-transform hover:scale-105 text-white"
      >
        <h1 className="text-base font-semibold">EDIT
        </h1>
        <h4 className="text-xs sm:text-sm whitespace-nowrap overflow-hidden text-ellipsis">
